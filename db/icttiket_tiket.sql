...
--
-- Host: localhost:3306
-- Generation Time: Sep 25, 2023 at 10:53 AM
...
(1, 'Ridho', '$2y$10$sJt9fpFQQazrDm31ZqAjVOMdW2O.ydypzbsLKnAMETPWAF7qnE03K', 'ridho.undhari@gmail.com', '2023-08-26 18:36:05'),
(4, 'administrator', '$2y$10$u48l18WGmjDdaStxQanaiOfLS/EAvZEghXNeOsrO3HllVU3vjKX8y', 'admin@gmail.ict', '2023-09-22 01:44:42');
...
CREATE TABLE `excel` (
  ...
  `dueby_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `exel` (
  ...
  `DueBy_Time` varchar(100) DEFAULT NULL,
  `Progres_Minggu_Ini` decimal(10,0) DEFAULT NULL,
  `Proggres_Minggu_Lalu` decimal(10,0) DEFAULT NULL,
  `Keterangan_Stopper` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `exel` (`id`, `Change_ID`, `Request_ID`, `Subject`, `Requester`, `Request_Status`, `priority`, `Request_Type`, `Technician`, `Site`, `Created_Time`, `DueBy_Time`, `Progres_Minggu_Ini`, `Proggres_Minggu_Lalu`, `Keterangan_Stopper`) VALUES
...
INSERT INTO `history_hapus` (`id`, `deleted_id`, `deletion_date`) VALUES
...
INSERT INTO `pM_ict` (`id`, `nama`, `universitas`, `jenis_kelamin`, `tgl_masuk`, `tgl_keluar`, `gambar`) VALUES
...
(76, 'SUCI RAMADANI', 'SMK 1 SAWAHLUNTO', 'Perempuan', '2023-06-19', '2023-09-22', 'uploads/WhatsApp Image 2023-09-20 at 13.47.16.jpeg'),
(77, 'Qori surya putra', 'smk n 2 Padang Panjang', 'Laki-Laki', '2023-07-17', '2023-12-15', 'uploads/WhatsApp Image 2023-09-20 at 10.39.54.jpeg'),
(78, 'febrio fernando', 'SMKN 2 Padang Panjang', 'Laki-Laki', '2023-07-17', '2023-12-15', 'uploads/WhatsApp Image 2023-09-20 at 14.45.01.jpeg'),
(79, 'Ferdian Saputra', 'smk 2 Padang Panjang', 'Laki-Laki', '2023-07-17', '2023-12-15', 'uploads/WhatsApp Image 2023-09-20 at 10.52.56.jpeg'),
(80, 'Wulan Dari', 'Institut Teknologi Padang', 'Perempuan', '2023-08-07', '2023-09-18', 'uploads/WhatsApp Image 2023-09-20 at 10.54.44.jpeg'),
(81, 'Muhammad Zaidan', 'PNP', 'Laki-Laki', '2023-08-21', '2024-01-22', 'uploads/zaidan 1.jpg'),
(82, 'Puja Patrioza', 'Politeknik Negeri Padang', 'Perempuan', '2023-08-21', '2024-01-22', 'uploads/puja-HjXLL8229-transformed (1).png'),
(83, 'Vania Vikri Ramadhani', 'Politeknik Negeri Padang', 'Perempuan', '2023-08-21', '2024-01-22', 'uploads/vania-LsuEsLA8F-transformed (1).png'),
...
(87, 'Arvan Fikri', 'SMK Negeri 2 Padang Panjang', 'Laki-Laki', '2023-07-17', '2023-12-15', 'uploads/WhatsApp Image 2023-09-20 at 10.38.08.jpeg'),
(88, 'Alya Akhirani', 'SMK 1 SAWAHLUNTO', 'Perempuan', '2023-06-19', '2023-09-22', 'uploads/WhatsApp Image 2023-09-20 at 10.35.49.jpeg'),
(89, 'Zoria Arista Molano', 'Univ Telkom', 'Perempuan', '2023-07-03', '2023-09-01', 'uploads/Jepretan Layar 2023-09-20 pukul 16.03.46.png'),
(90, 'izza', 'Politeknik Negeri Padang', 'Perempuan', '2023-08-21', '2024-01-22', 'uploads/izza-0QXwVAOGJ-transformed (1).png'),
(91, 'Beni Akmal', 'smk 2 Padang Panjang', 'Laki-Laki', '2023-06-17', '2023-12-15', 'uploads/sp 1.jpg');
